export enum ControleAtualizacaoColumnName {
    id = 'id',
...
export enum ControleProcessosColumnName {
    contrato =  'contrato',
    razaoSocial = 'nomecli',
    cidade = 'cidacli',
...
export enum RejeicoesFiscaisColumn {
    id = 'id',
    contrato = 'contrato',
...
export enum PendenciasConciliacaoColumn {
    id = 'id',
    contrato = 'contrato',
